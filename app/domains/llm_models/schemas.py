...
class LanguageModelCreate(BaseModel):
    ...
    input_token_price: int = Field(..., description="The input token price of the model", examples=[1])
    output_token_price: int = Field(..., description="The output token price of the model", examples=[1])
